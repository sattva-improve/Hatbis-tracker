#!/usr/bin/env python3
"""Generate API request/response examples for documentation."""
import json
import sys
import os
...
os.environ["COGNITO_ENDPOINT_URL"] = "http://localhost:4566"
...
def generate_examples():
    ...
    # POST /auth/signout
    examples["auth_signout"] = {
        "endpoint": "POST /auth/signout",
        "description": "ログアウト",
        "request": {
            "headers": {
                "Authorization": "Bearer eyJraWQiOiJhYmNkZWYxMjM0NTY3ODkwIiwiYWxnIjoiUlMyNTYifQ..."
            }
        },
        "response_204": {
            "statusCode": 204,
    ...
    # GET /users/me/stats
    examples["users_get_stats"] = {
        "endpoint": "GET /users/me/stats",
        "description": "自分のステータス詳細取得",
        "request": {
            "headers": {
                "Authorization": "Bearer eyJraWQiOiJhYmNkZWYxMjM0NTY3ODkwIiwiYWxnIjoiUlMyNTYifQ..."
            }
    ...
    examples["habits_get"] = {
        ...
        "request": {
            ...
            "path_params": {
                "habitId": "01HRQY5K4MZJP7Y9GF2D5N3B6C"
            }
        },
        "response_200": {
            "statusCode": 200,
    ...
    examples["habits_archive"] = {
        "endpoint": "POST /habits/{habitId}/archive",
        "description": "習慣アーカイブ",
        "request": {
            "headers": {
                "Authorization": "Bearer eyJraWQiOiJhYmNkZWYxMjM0NTY3ODkwIiwiYWxnIjoiUlMyNTYifQ..."
    ...
    examples["records_list"] = {
        "endpoint": "GET /habits/{habitId}/records",
        "description": "習慣記録一覧取得",
        "request": {
            "headers": {
                "Authorization": "Bearer eyJraWQiOiJhYmNkZWYxMjM0NTY3ODkwIiwiYWxnIjoiUlMyNTYifQ..."
            },
    ...
    examples["records_create"] = {
        "endpoint": "POST /habits/{habitId}/records",
        "description": "習慣記録作成（達成報告）",
        "request": {
            "headers": {
                "Authorization": "Bearer eyJraWQiOiJhYmNkZWYxMjM0NTY3ODkwIiwiYWxnIjoiUlMyNTYifQ..."
            },
        ...
        "response_201_with_achievements": {
            "statusCode": 201,
            "body": {
                "record": {
                    "record_id": "01HRR15K4MZJP7Y9GF2D5N3B6F",
    ...
    # GET /records/today
    examples["records_today"] = {
        "endpoint": "GET /records/today",
        "description": "今日の達成状況取得",
        "request": {
            "headers": {
                "Authorization": "Bearer eyJraWQiOiJhYmNkZWYxMjM0NTY3ODkwIiwiYWxnIjoiUlMyNTYifQ..."
            }
    ...
    # GET /stats/monthly
    examples["stats_monthly"] = {
        "endpoint": "GET /stats/monthly",
        "description": "月次統計取得",
        "request": {
            "headers": {
                "Authorization": "Bearer eyJraWQiOiJhYmNkZWYxMjM0NTY3ODkwIiwiYWxnIjoiUlMyNTYifQ..."
    ...
    # GET /achievements
    examples["achievements_list"] = {
        "endpoint": "GET /achievements",
        "description": "アチーブメント一覧取得",
        "request": {
            "headers": {
                "Authorization": "Bearer eyJraWQiOiJhYmNkZWYxMjM0NTY3ODkwIiwiYWxnIjoiUlMyNTYifQ..."
            },
    ...
    # POST /jobs/{jobId}/equip
    examples["jobs_equip"] = {
        "endpoint": "POST /jobs/{jobId}/equip",
        "description": "ジョブ装備",
        "request": {
            "headers": {
                "Authorization": "Bearer eyJraWQiOiJhYmNkZWYxMjM0NTY3ODkwIiwiYWxnIjoiUlMyNTYifQ..."
...
def main():
    ...
    # Output directory
    output_dir = os.path.join(os.path.dirname(__file__), '..', 'docs', 'api-examples')
    os.makedirs(output_dir, exist_ok=True)
    
    # Save all examples to a JSON file
    output_file = os.path.join(output_dir, 'api_examples.json')
    ...
    for key, example in examples.items():
        print(f"  - {example['endpoint']}: {example['description']}")
